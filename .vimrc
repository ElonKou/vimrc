...
func SetTitle()
    if expand("%:e") == 'cpp' || expand("%:e") == 'cc'
        ...
        call append(line(".")+12, "    cout << \"Hello,elonkou!\";")
    ...
    if expand("%:e") == 'cu'
        ...
        call append(line(".")+5, "================================================================*/") 
        call append(line(".")+6, "")
        call append(line(".")+7, "#include <cuda_runtime.h>")
        call append(line(".")+8, "#include <device_launch_parameters.h>")
        call append(line(".")+9, "#include <stdio.h>")
        call append(line(".")+10, "")
        call append(line(".")+11, "__global__ void func(){")
        call append(line(".")+12, "    printf(\"id:%d\\n\", threadIdx.x);")
        call append(line(".")+13, "}")
        call append(line(".")+14, "")
        call append(line(".")+15, "int main(int argc, char *argv[]){")
        call append(line(".")+16, "    func<<<1, 10>>>();")
        call append(line(".")+17, "    cudaDeviceSynchronize();")
        call append(line(".")+18, "    cudaDeviceReset();")
